...
namespace MvcMember.Controllers
{
    public class CardInfoController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            CommonCls.WriteSysLog("查看会员资料", Request.RawUrl, this.Session["UserName"].ToString());
            return View();
        }
        ...
        public ActionResult Create()
        {
            ...
            if(DBContext.ActivityDb.Count() >0)
            {
            ...
            ViewBag.StartDate = v_cardinfo.StartDate.ToShortDateString();
            ViewBag.EndDate = v_cardinfo.EndDate.ToShortDateString();
            return View(v_cardinfo);
        }
        [CheckLogin]
        public ActionResult Setting()
        {
            ...
            int parentid2 = DBContext.ItemListDb.Where(w => w.ItemName == "业务分类").First().ID;
            ViewBag.serviceType = DBContext.ItemListDb.Where(w => w.ItemParent == parentid2).ToList();

            ViewBag.cardType = DBContext.CardTypeDb.ToList();
        ...
        public ActionResult Create(V_CardInfo v_cardinfo)
        {
            try
            {
                ...
                DBContext.SaveChanges();
                CommonCls.WriteSysLog("新增会员资料，会员卡号："+ v_cardinfo.CardNo, Request.RawUrl, this.Session["UserName"].ToString());
